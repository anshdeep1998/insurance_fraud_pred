...
class Prediction_Data_validation:
    """
               ...
               """
# The code explanation and code is exactly same as it's training counterpart i.e. rawValidation.py
# in Training_Raw_data_validation folder.

# For code explanation refer that, no repeated explanation here.
